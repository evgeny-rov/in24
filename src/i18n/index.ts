...
const resources: ResourcesStrct = {
  en: {
    translation: {
      ...
      info_hover: 'Info',
      info_1: 'Complete todos will be removed in 24 hours.',
      info_2: 'Try to complete all todos in a day!',
  ...
  ru: {
    translation: {
      ...
      info_hover: 'Инфо',
      info_1: 'Выполненные задачи удаляются через 24 часа.',
      info_2: 'Постарайся выполнить все за день!',
      info_3: 'Чтобы удалить запись смахни ее вправо',
      info_4: 'или щелкни дважды на галочку.',
      info_5: 'Утилизация очищает все выполненные задачи.',
